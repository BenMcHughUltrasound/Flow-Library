...
t = transpose(0:4e-8:5e-6);
y = sin(2*pi*1e6*t);
driver = WaveformObj(1,1,t,y);
fftDrive = scope.fftObj(driver, 1,1,1e5);
...
reprod1 = scope.IFFTObj(Trans10to4win);
reprod1 = scope.normWaveObj(reprod1);
reprod2 = scope.IFFTObj(Trans4to10win);
reprod2 = scope.normWaveObj(reprod2);
...
scope.plt(reprod2,2)
xlim([0,100])
scope.plt(scope.normWaveObj(Transmit10Recieve4Raw), 3)
