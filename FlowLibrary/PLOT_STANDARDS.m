...
function PS = PLOT_STANDARDS()
    ...
    d = listfonts;
        ...
        PS.DefaultFont = 'Times New Roman';
        PS.AxisNumbersFontName = 'Times New Roman';
        PS.AxisFont = 'Times New Roman';
        PS.LegendFont = 'Times New Roman';
        PS.TitleFont = 'Times New Roman';
        PS.PlotTextFont = 'Times New Roman';
